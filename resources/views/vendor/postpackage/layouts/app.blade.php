...
<head>
    ...
    <link rel="stylesheet" href="{{asset('postpackage/css/app.css')}}">
    <script src="{{asset('postpackage/js/app.js')}}"></script>
    <livewire:styles />
</head>
<body>
      ...
      <div class="fixed inset-0 z-40 flex">
        <!--
          ...
          Leaving: "transition ease-in-out duration-300 transform"
            ...
            To: "-translate-x-full"
        -->
        <div class="relative flex w-full max-w-xs flex-1 flex-col bg-indigo-700 pt-5 pb-4" id="">
          <!--
        ...
        <div class="flex flex-1 justify-between px-4">
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              <div>
                <button type="button" class="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true" onclick="togglemenu()">
              ...
              -->
              <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden" id="right-top-menu" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
      ...
      <main>
        <div class="py-6">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
            @yield('name-page','Dashboard')
            @yield('description-page','This is page dashboard')
          </div>
          <div class="my-3 ml-5">
            <nav class="flex" aria-label="Breadcrumb">
              <ol role="list" class="flex space-x-4 rounded-md bg-white px-6 shadow">
                ...
                @yield('breadcrum-first')
                
                @yield('breadcrum-second')
