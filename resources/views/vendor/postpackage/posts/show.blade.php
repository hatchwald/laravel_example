...
<li class="flex">
    <div class="flex items-center">
      ...
      <a href="/blog/post/{{$post->id}}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">{{$post->title}}</a>
    </div>
  </li>
@endsection
@section('alert')
          ...
          <div class="space-y-6 sm:space-y-5">
            ...
            <div class="space-y-6 sm:space-y-5">
              <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div class="mt-1 sm:col-span-2 sm:mt-0">
                  <div class="flex max-w-lg rounded-md shadow-sm">
                    <input type="text" value="{{$post->title}}" name="title" id="title" autocomplete="title" class="block w-full min-w-0 flex-1 rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                  </div>
                </div>
              </div>
              ...
              <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
                ...
                <div class="mt-1 sm:col-span-2 sm:mt-0">
                  <textarea id="body" name="body" rows="3" class="block w-full max-w-lg rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{$post->body}}</textarea>
